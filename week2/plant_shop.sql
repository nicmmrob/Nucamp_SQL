...
9	Nic	Robbins	nicmmrob@gmail.com	\N
\.
...
COPY public.transactions (trans_id, payment_method, order_number, plant_id, cust_email) FROM stdin;
3	credit	\N	1	nicmmrob@gmail.com
\.
...
SELECT pg_catalog.setval('public.transactions_trans_id_seq', 3, true);
